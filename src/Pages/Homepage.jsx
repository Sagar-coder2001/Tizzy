...
const Homepage = () => {
  ...
  return (
    <section className="mt-8 w-full bg-gradient-to-b py-10 sm:px-10 bg-[#689267]">
        ...
        >
          <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-gray-600 leading-snug font-mono">
            <span className="text-black">
              <span className="text-red-500 font-extrabold">PREMIUM<span className="inline-block"></span></span> Cloud Business<br />
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <motion.div
              key={index}
              className="rounded-2xl transition shadow-[0_0_5px_0px_rgba(0,0,255,0.4)] hover:shadow-[0_0_5px_2px_rgba(0,0,255,0.4)] p-6 flex items-center gap-4 text-white bg-[#c5dfc8]"
            ...
            >
              <img
                src={service.img}
                alt={service.label}
                className="w-20 h-20 object-contain rounded-full shadow-md bg-white"
              />
              <div>
      ...
      <div className="max-w-6xl mx-auto px-4 text-center">
        <h2 className="text-2xl md:text-3xl font-bold mb-2 text-grey-800">
